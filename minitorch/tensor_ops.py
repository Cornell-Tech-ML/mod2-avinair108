    ...
    * Fill in the `out` array by applying `fn` to each
    ...
    def _map(
        ...
        for i in range(out_size):
            ...
            # Broadcast the output index into the input index
            broadcast_index(out_index, out_shape, in_shape, in_index)

            # Convert the input and output indices to flat positions in storage
    ...
    * Fill in the `out` array by applying `fn` to each
    ...
    def _zip(
        ...
        for i in range(out_size):
            ...
            # Broadcast the output index into the input indices for both tensors
            ...
            # Apply the function to the input tensors and store the result
